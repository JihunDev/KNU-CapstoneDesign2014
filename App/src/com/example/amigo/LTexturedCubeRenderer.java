...
public class LTexturedCubeRenderer implements Renderer {
	...
	public LTexturedCubeRenderer(Context context) {
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glRotatef(150, BluetoothChat.re[0],BluetoothChat.re[1],BluetoothChat.re[2]);
